...
def get_intersection(triangles_vec, ray, max_reflection, reflection_depth = 0):
    ...
    for tri in triangles_vec:
        ...
        invdet = 1/vec_tools.det3(d, E1, E2)

        t = vec_tools.det3(VO, E1, E2) * invdet * -1
        u = vec_tools.det3(d, VO, E2) * invdet
        v = vec_tools.det3(d, E1, VO) * invdet
...
def main():
    ...
    for pixel_x in range(resolution[0]):
        for pixel_y in range(resolution[1]):
            #pixel_x, pixel_y = int(720/2), int(720/2)
